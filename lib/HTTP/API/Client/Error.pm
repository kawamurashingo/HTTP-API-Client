...
HTTP::API::Client::Error - Structured errors from HTTP::API::Client

=head1 DESCRIPTION

HTTP::API::Client throws structured error objects. The C<category> value is the
...
Returns the associated L<HTTP::API::Client::Response> for HTTP/decode errors,
