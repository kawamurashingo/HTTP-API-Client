...
HTTP::API::Client::Auth - Small authentication helpers for HTTP::API::Client
...
schemes. It deliberately builds on HTTP::API::Client's existing hook mechanism
