...
my $next = HTTP::API::Client::Pagination->new(
    client => $next_client,
    path   => '/users',
    mode   => 'next_url',
    items  => 'data.items',
...
my $page = HTTP::API::Client::Pagination->new(
    client    => $page_client,
    path      => '/users',
    mode      => 'page',
    items     => 'items',
...
my $cursor = HTTP::API::Client::Pagination->new(
...
my $repeat = HTTP::API::Client::Pagination->new(
